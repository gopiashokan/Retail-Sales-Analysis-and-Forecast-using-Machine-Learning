...
if button and option == 'Migrating to SQL':
    ...
    with col2:
        ...
        with st.spinner('Deleting the Existing Data...'):
            sql.delete_table()
    ...
    tab1,tab2 = st.tabs(['Features', 'Store'])
    ...
    with tab1:
        ...
        columns = ['size', 'temperature', 'fuel_price', 'markdown1', 'markdown2', 
                'markdown3', 'markdown4', 'markdown5', 'cpi', 'unemployment']
    ...
    col1,col2,col3 = st.columns([0.21,0.58,0.21])
